...
export const metadata: Metadata = {
  title: "Dhaka Office | BIIC Global",
  description: "Visit our Dhaka head office at Zeenat Center 2, Uttara for expert study abroad counseling, visa assistance, IELTS preparation, and scholarship guidance.",
};
...
const services = [
  ...
  { icon: FaMicrophone, title: "IELTS Preparation", desc: "Regular batches, weekend classes, crash courses, and mock tests by band 9 certified trainers.", href: "/services/ielts-preparation" },
  ...
  { icon: FaUsers, title: "Free Seminars & Events", desc: "Regular free events, open days, and webinars at our Dhaka office. Open to all.", href: "/events" },
];

const teamMembers = [
  { name: "Md. Rafiqul Islam", title: "Head Counselor — UK & Europe", initials: "RI" },
  { name: "Nusrat Fatema", title: "Visa Specialist — Canada & Australia", initials: "NF" },
  { name: "Shahriar Hossain", title: "IELTS Trainer (Band 9)", initials: "SH" },
  { name: "Tania Begum", title: "Scholarship Advisor", initials: "TB" },
];
...
export default function DhakaOfficePage() {
  return (
    <>
      ...
      <div className="border-b border-gray-100 py-3 px-4 bg-white">
        <div className="max-w-6xl mx-auto flex items-center gap-2 text-sm text-gray-500">
          ...
          <FaChevronRight className="w-3 h-3" />
          <span className="text-red-700 font-black">Dhaka Office</span>
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-red-100 border border-red-200 rounded-full px-4 py-2 mb-5">
              ...
              <span className="text-red-700 text-xs font-black uppercase tracking-widest">Head Office — Dhaka</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-red-900 mb-4 leading-tight">
              BIIC Global<br />
              <span className="text-red-600">Dhaka Office</span>
            </h1>
            <p className="text-gray-500 text-lg mb-6 leading-relaxed">
              Our main office in Uttara, Dhaka — serving thousands of students every year with expert study abroad counseling, visa assistance, and IELTS coaching.
            </p>

            <div className="space-y-3 mb-8">
              {[
                { icon: FaLocationDot, text: "III/A, Zeenat Center 2, Road 07, Sector 04, Rajlokkhi, Uttara, Dhaka" },
                { icon: FaPhone, text: "+880 96138-20821" },
                { icon: FaWhatsapp, text: "WhatsApp: +880 96138-20821" },
                { icon: FaEnvelope, text: "dhaka@biicglobal.com" },
              ].map(({ icon: Icon, text }) => (
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white h-80 bg-gray-100 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="font-black text-gray-700">Zeenat Center 2, Uttara</p>
              <p className="text-gray-400 text-sm mt-1">Road 07, Sector 04, Rajlokkhi</p>
      ...
      <section className="py-20 px-4" style={{ background: "linear-gradient(135deg,#fff9f9 0%,#ffffff 60%,#fff5f5 100%)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-black text-gray-900 mt-2">Services at Dhaka Office</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-2 mb-6">What to Expect at Our Dhaka Office</h2>
      ...
      <section className="py-16 px-4" style={{ background: "linear-gradient(135deg,#fff9f9 0%,#ffffff 60%,#fff5f5 100%)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-gray-900 mt-2">Meet the Dhaka Team</h2>
          </div>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { city: "Chattogram", addr: "Aerial Legend (4th Floor), CDA Avenue, beside O R Nizam Rd 7, East Nasirabad, GEC Circle, Chattogram", href: "/offices/chattogram" },
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-red-950 via-red-900 to-red-800">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-red-200 mb-6">Walk into our Dhaka office or book a free counseling session online.</p>
